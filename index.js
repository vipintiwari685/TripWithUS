...
function getHotelsByAscendingPrice(hotel1, hotel2) {
  return hotel1.price - hotel2.price;
}

function getHotelsByDescendingPrice(hotel1, hotel2) {
  return hotel2.price - hotel1.price;
}

function getHotelsByAscendingRating(hotel1, hotel2) {
  return hotel1.rating - hotel2.rating;
}

function getHotelsByDescendingRating(hotel1, hotel2) {
  return hotel2.rating - hotel1.rating;
}

function getHotelsByAscendingReview(hotel1, hotel2) {
  return hotel1.reviews - hotel2.reviews;
}

function getHotelsByDescendingReview(hotel1, hotel2) {
...
app.get('/hotels/sort/pricing', (req, res) => {
  ...
  if (req.query.pricing === 'low-to-high') {
    hotelsCopy.sort(getHotelsByAscendingPrice);
  } else {
    hotelsCopy.sort(getHotelsByDescendingPrice);
  }
  res.json(hotelsCopy);
});
...
app.get('/hotels/sort/rating', (req, res) => {
  ...
  if (req.query.rating === 'low-to-high') {
    hotelsCopy.sort(getHotelsByAscendingRating);
  } else {
    hotelsCopy.sort(getHotelsByDescendingRating);
  }
  res.json(hotelsCopy);
});
...
app.get('/hotels/sort/reviews', (req, res) => {
  ...
  if (req.query.reviews === 'least-to-most') {
    hotelsCopy.sort(getHotelsByAscendingReview);
  } else {
    hotelsCopy.sort(getHotelsByDescendingReview);
  }
  res.json(hotelsCopy);
});
